const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/MainMenu-CsnX-Esy.js","assets/audioEngine-Bbt5mT95.js","assets/proxy-BE2cmtP9.js","assets/GameCanvas-DKe1kT9w.js","assets/GameModeSelect-DQ3pclhB.js","assets/UpgradeShop-D9FWbEWO.js","assets/Leaderboard-Dk-DUPih.js","assets/AchievementsScreen-XbR6nNEN.js","assets/SettingsScreen-nL15MYZ8.js"])))=>i.map(i=>d[i]);
...
const PLAYER_BOOST_DURATION = 600;
const PLAYER_BOOST_COOLDOWN = 3e3;
const PLAYER_INVINCIBLE_DURATION = 1500;
...
const DEFAULT_PROFILE = {
  ...
  weapons: Object.keys(WEAPON_STATS).map((w) => ({
    weapon: w,
    level: 1,
    damage: WEAPON_STATS[w].damage,
    fireRate: WEAPON_STATS[w].fireRate,
    unlocked: w === "laser"
  })),
  playerLevel: 1,
  playerXp: 0,
...
const useGameStore = create()(
  persist(
    (set, get) => ({
      ...
      setGameSave: (save) => set({ gameSave: save }),
      updateSettings: (partial) => set((state) => ({
        settings: { ...state.settings, ...partial },
        gameSave: state.gameSave ? { ...state.gameSave, settings: { ...state.settings, ...partial } } : state.gameSave
      })),
      ...
      upgradeWeapon: (weapon) => {
        ...
        const wUpgrades = profile.weapons.map((w) => {
          ...
          WEAPON_STATS[costKey].upgradeCost;
          return {
            ...w,
            level: newLevel,
    ...
    }),
    {
      ...
      onRehydrateStorage: () => (state) => {
        state == null ? void 0 : state.setHasHydrated(true);
      }
    }
  )
);
const MainMenu = reactExports.lazy(() => __vitePreload(() => import("./MainMenu-CsnX-Esy.js"), true ? __vite__mapDeps([0,1,2]) : void 0));
const GameCanvas = reactExports.lazy(() => __vitePreload(() => import("./GameCanvas-DKe1kT9w.js"), true ? __vite__mapDeps([3,1]) : void 0));
const GameModeSelect = reactExports.lazy(() => __vitePreload(() => import("./GameModeSelect-DQ3pclhB.js"), true ? __vite__mapDeps([4,1,2]) : void 0));
const UpgradeShop = reactExports.lazy(() => __vitePreload(() => import("./UpgradeShop-D9FWbEWO.js"), true ? __vite__mapDeps([5,1,2]) : void 0));
const Leaderboard = reactExports.lazy(() => __vitePreload(() => import("./Leaderboard-Dk-DUPih.js"), true ? __vite__mapDeps([6,1,2]) : void 0));
const AchievementsScreen = reactExports.lazy(() => __vitePreload(() => import("./AchievementsScreen-XbR6nNEN.js"), true ? __vite__mapDeps([7,1,2]) : void 0));
const SettingsScreen = reactExports.lazy(() => __vitePreload(() => import("./SettingsScreen-nL15MYZ8.js"), true ? __vite__mapDeps([8,1,2]) : void 0));
function LoadingScreen() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-space-black flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center animate-scale-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl font-display font-bold text-neon-cyan text-glow-cyan mb-4", children: "GALAXY STRIKE X" }),
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingScreen, {}), children: [
        screen === "menu" && /* @__PURE__ */ jsxRuntimeExports.jsx(MainMenu, {}),
        screen === "mode_select" && /* @__PURE__ */ jsxRuntimeExports.jsx(GameModeSelect, {}),
        screen === "game" && /* @__PURE__ */ jsxRuntimeExports.jsx(GameCanvas, {}),
        screen === "pause" && /* @__PURE__ */ jsxRuntimeExports.jsx(GameCanvas, {}),
        " ",
        screen === "game_over" && /* @__PURE__ */ jsxRuntimeExports.jsx(GameCanvas, {}),
        " ",
        screen === "shop" && /* @__PURE__ */ jsxRuntimeExports.jsx(UpgradeShop, {}),
        screen === "leaderboard" && /* @__PURE__ */ jsxRuntimeExports.jsx(Leaderboard, {}),
        screen === "achievements" && /* @__PURE__ */ jsxRuntimeExports.jsx(AchievementsScreen, {}),
        screen === "settings" && /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsScreen, {})
      ] })
    }
  );
}
...
export {
  lebDecode as $,
  focusManager as A,
  BOSS_EVERY_N_WAVES as B,
  COLORS as C,
  DIFFICULTY_SCALE_PER_WAVE as D,
  ENEMY_STATS as E,
  fetchState as F,
  GAME_MODES as G,
  replaceData as H,
  ...
  unwrapDER as a$,
  slebDecode as a0,
  PipeArrayBuffer as a1,
  Principal as a2,
  InputError as a3,
  CborEncodeErrorCode as a4,
  CborDecodeErrorCode as a5,
  ExpiryJsonDeserializeErrorCode as a6,
  utf8ToBytes as a7,
  _validateObject as a8,
  isHash as a9,
  FpLegendre as aA,
  notImplemented as aB,
  bitGet as aC,
  sha256 as aD,
  numberToBytesBE as aE,
  UNREACHABLE_ERROR as aF,
  UnknownError as aG,
  HashTreeDecodeErrorCode as aH,
  uint8Equals as aI,
  ProtocolError as aJ,
  CertificateVerificationErrorCode as aK,
  TrustError as aL,
  CertificateTimeErrorCode as aM,
  UnexpectedErrorCode as aN,
  CertificateHasTooManyDelegationsErrorCode as aO,
  CertificateNotAuthorizedErrorCode as aP,
  MissingLookupValueErrorCode as aQ,
  DerKeyLengthMismatchErrorCode as aR,
  DerPrefixMismatchErrorCode as aS,
  LookupErrorCode as aT,
  MalformedLookupFoundValueErrorCode as aU,
  hexToBytes as aV,
  ExternalError as aW,
  MissingRootKeyErrorCode as aX,
  AgentError as aY,
  wrapDER as aZ,
  ED25519_OID as a_,
  abytes as aa,
  mod as ab,
  concatBytes as ac,
  bytesToNumberBE as ad,
  isBytes as ae,
  FpInvertBatch as af,
  Field as ag,
  _createCurveFields as ah,
  wNAF as ai,
  ensureBytes as aj,
  _abool2 as ak,
  _abytes2 as al,
  ...
  bitLen as au,
  validateField as av,
  getMinHashLength as aw,
  mapHashToField as ax,
  randomBytes as ay,
  FpPow as az,
  CANVAS_WIDTH as b,
  DerDecodeErrorCode as b0,
  hashOfMap as b1,
  IC_RESPONSE_DOMAIN_SEPARATOR as b2,
  MalformedPublicKeyErrorCode as b3,
  ed25519 as b4,
  QuerySignatureVerificationFailedErrorCode as b5,
  AnonymousIdentity as b6,
  IngressExpiryInvalidErrorCode as b7,
  CreateHttpAgentErrorCode as b8,
  IdentityInvalidErrorCode as b9,
  requestIdOf as ba,
  HttpV3ApiNotSupportedErrorCode as bb,
  TimeoutWaitingForResponseErrorCode as bc,
  uint8FromBufLike as bd,
  HttpErrorCode as be,
  TransportError as bf,
  HttpFetchErrorCode as bg,
  MalformedSignatureErrorCode as bh,
  CertificateOutdatedErrorCode as bi,
  MissingSignatureErrorCode as bj,
  HttpDefaultFetchErrorCode as bk,
  RequestStatusDoneNoReplyErrorCode as bl,
  RejectError as bm,
  CertifiedRejectErrorCode as bn,
  InvalidReadStateRequestErrorCode as bo,
  MissingCanisterIdErrorCode as bp,
  UncertifiedRejectErrorCode as bq,
  UncertifiedRejectUpdateErrorCode as br,
  CANVAS_HEIGHT as c,
  PLAYER_BOOST_COOLDOWN as d,
  PLAYER_BOOST_DURATION as e,
  PLAYER_BOOST_SPEED as f,
  PLAYER_SPEED as g,
  PARTICLE_COUNTS as h,
  PLAYER_INVINCIBLE_DURATION as i,
  jsxRuntimeExports as j,
  COMBO_MULTIPLIER_MAX as k,
  COMBO_TIMEOUT as l,
  PLAYER_RADIUS as m,
  ENEMIES_PER_WAVE_BASE as n,
  ENEMIES_PER_WAVE_INCREMENT as o,
