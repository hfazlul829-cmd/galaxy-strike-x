...
import { M as slebEncode, N as safeReadUint8, O as iexp2, Q as writeIntLE, R as readIntLE, T as writeUIntLE, U as readUIntLE, V as safeRead, X as uint8ToDataView, Y as lebEncode, Z as concat, $ as lebDecode, a0 as slebDecode, a1 as PipeArrayBuffer, a2 as Principal$1, a3 as InputError, a4 as CborEncodeErrorCode, a5 as CborDecodeErrorCode, a6 as ExpiryJsonDeserializeErrorCode, a7 as utf8ToBytes, a8 as _validateObject, a9 as isHash, aa as abytes, ab as mod, ac as concatBytes, ad as bytesToNumberBE, ae as isBytes, af as FpInvertBatch, ag as Field, ah as _createCurveFields, ai as wNAF, aj as ensureBytes, ak as _abool2, al as _abytes2, am as normalizeZ, an as mulEndoUnsafe, ao as bytesToHex, ap as pippenger, aq as inRange, ar as memoized, as as negateCt, at as bitMask, au as bitLen, av as validateField, aw as getMinHashLength, ax as mapHashToField, ay as randomBytes, az as FpPow, aA as FpLegendre, aB as notImplemented, aC as bitGet, aD as sha256, aE as numberToBytesBE, aF as UNREACHABLE_ERROR, aG as UnknownError, aH as HashTreeDecodeErrorCode, aI as uint8Equals, aJ as ProtocolError, aK as CertificateVerificationErrorCode, aL as TrustError, aM as CertificateTimeErrorCode, aN as UnexpectedErrorCode, aO as CertificateHasTooManyDelegationsErrorCode, aP as CertificateNotAuthorizedErrorCode, aQ as MissingLookupValueErrorCode, aR as DerKeyLengthMismatchErrorCode, aS as DerPrefixMismatchErrorCode, aT as LookupErrorCode, aU as MalformedLookupFoundValueErrorCode, aV as hexToBytes, aW as ExternalError, aX as MissingRootKeyErrorCode, aY as AgentError, aZ as wrapDER, a_ as ED25519_OID, a$ as unwrapDER, b0 as DerDecodeErrorCode, b1 as hashOfMap, b2 as IC_RESPONSE_DOMAIN_SEPARATOR, b3 as MalformedPublicKeyErrorCode, b4 as ed25519, b5 as QuerySignatureVerificationFailedErrorCode, b6 as AnonymousIdentity, b7 as IngressExpiryInvalidErrorCode, b8 as CreateHttpAgentErrorCode, b9 as IdentityInvalidErrorCode, ba as requestIdOf, bb as HttpV3ApiNotSupportedErrorCode, bc as TimeoutWaitingForResponseErrorCode, bd as uint8FromBufLike, be as HttpErrorCode, bf as TransportError, bg as HttpFetchErrorCode, bh as MalformedSignatureErrorCode, bi as CertificateOutdatedErrorCode, bj as MissingSignatureErrorCode, bk as HttpDefaultFetchErrorCode, bl as RequestStatusDoneNoReplyErrorCode, bm as RejectError, bn as CertifiedRejectErrorCode, bo as InvalidReadStateRequestErrorCode, bp as MissingCanisterIdErrorCode, bq as UncertifiedRejectErrorCode, br as UncertifiedRejectUpdateErrorCode } from "./index-BeDg1Gbc.js";
...
const AchievementId = Nat;
const Timestamp = Int;
const AchievementStatus = Record({
  "achievementId": AchievementId,
  "unlockedAt": Opt(Timestamp),
  "unlocked": Bool
});
const GameMode$1 = Variant({
  "endless": Null,
  "hardcore": Null,
  "story": Null,
  "bossBattle": Null
...
const SkinId = Nat;
const GameSave = Record({
  "weaponLevels": WeaponLevels,
  "purchaseHistory": Vec(PurchaseRecord),
  "lastSaved": Timestamp,
  "unlockedSkins": Vec(SkinId)
});
const SubmitScoreRequest = Record({
  "waveReached": Nat,
  "score": Nat,
  "gameMode": GameMode$1
});
Service({
  "getAchievements": Func([], [Vec(AchievementStatus)], ["query"]),
  "getLeaderboard": Func([], [Vec(LeaderboardEntry)], ["query"]),
  "getPlayerProfile": Func([], [Opt(PlayerProfile)], ["query"]),
  "loadGameState": Func([], [GameSave], ["query"]),
  "saveGameState": Func(
    [WeaponLevels, Vec(SkinId), Vec(PurchaseRecord)],
    [],
    []
  ),
  "submitScore": Func([SubmitScoreRequest], [], []),
  "unlockAchievement": Func([AchievementId], [Bool], []),
  "updatePlayerProfile": Func(
    [
      Opt(Text),
      Opt(Nat),
      Opt(Int),
...
const idlFactory = ({ IDL: IDL2 }) => {
  const AchievementId2 = IDL2.Nat;
  const Timestamp2 = IDL2.Int;
  const AchievementStatus2 = IDL2.Record({
    "achievementId": AchievementId2,
    "unlockedAt": IDL2.Opt(Timestamp2),
    "unlocked": IDL2.Bool
  });
  const GameMode2 = IDL2.Variant({
    "endless": IDL2.Null,
    "hardcore": IDL2.Null,
    "story": IDL2.Null,
    "bossBattle": IDL2.Null
  });
  const LeaderboardEntry2 = IDL2.Record({
    "username": IDL2.Text,
    "player": IDL2.Principal,
    "waveReached": IDL2.Nat,
    "score": IDL2.Nat,
  ...
  const PlayerProfile2 = IDL2.Record({
    "username": IDL2.Text,
    "lifetimeKills": IDL2.Nat,
    "totalXP": IDL2.Nat,
    "totalCoins": IDL2.Nat,
    "level": IDL2.Nat
  });
  const WeaponLevels2 = IDL2.Vec(IDL2.Nat);
  const PurchaseRecord2 = IDL2.Record({
    "itemId": IDL2.Nat,
    "cost": IDL2.Nat,
    "timestamp": Timestamp2,
    "itemType": IDL2.Variant({
      "skin": IDL2.Null,
      "powerup": IDL2.Null,
      "weapon": IDL2.Null
    })
  });
  const SkinId2 = IDL2.Nat;
  const GameSave2 = IDL2.Record({
    "weaponLevels": WeaponLevels2,
    "purchaseHistory": IDL2.Vec(PurchaseRecord2),
    "lastSaved": Timestamp2,
    "unlockedSkins": IDL2.Vec(SkinId2)
  });
  const SubmitScoreRequest2 = IDL2.Record({
    "waveReached": IDL2.Nat,
    "score": IDL2.Nat,
    "gameMode": GameMode2
  });
  return IDL2.Service({
    "getAchievements": IDL2.Func([], [IDL2.Vec(AchievementStatus2)], ["query"]),
    "getLeaderboard": IDL2.Func([], [IDL2.Vec(LeaderboardEntry2)], ["query"]),
    "getPlayerProfile": IDL2.Func([], [IDL2.Opt(PlayerProfile2)], ["query"]),
    "loadGameState": IDL2.Func([], [GameSave2], ["query"]),
    "saveGameState": IDL2.Func(
      [WeaponLevels2, IDL2.Vec(SkinId2), IDL2.Vec(PurchaseRecord2)],
      [],
      []
    ),
    "submitScore": IDL2.Func([SubmitScoreRequest2], [], []),
    "unlockAchievement": IDL2.Func([AchievementId2], [IDL2.Bool], []),
    "updatePlayerProfile": IDL2.Func(
      [
        IDL2.Opt(IDL2.Text),
        IDL2.Opt(IDL2.Nat),
        IDL2.Opt(IDL2.Int),
...
var GameMode = /* @__PURE__ */ ((GameMode2) => {
  GameMode2["endless"] = "endless";
  GameMode2["hardcore"] = "hardcore";
  GameMode2["story"] = "story";
  GameMode2["bossBattle"] = "bossBattle";
  return GameMode2;
})(GameMode || {});
var Variant_skin_powerup_weapon = /* @__PURE__ */ ((Variant_skin_powerup_weapon2) => {
  Variant_skin_powerup_weapon2["skin"] = "skin";
  Variant_skin_powerup_weapon2["powerup"] = "powerup";
  Variant_skin_powerup_weapon2["weapon"] = "weapon";
  return Variant_skin_powerup_weapon2;
...
class Backend {
  ...
  async saveGameState(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async updatePlayerProfile(arg0, arg1, arg2, arg3, arg4) {
    if (this.processError) {
      try {
...
function from_candid_AchievementStatus_n2(_uploadFile, _downloadFile, value) {
  return from_candid_record_n3(_uploadFile, _downloadFile, value);
}
function from_candid_GameMode_n8(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n9(_uploadFile, _downloadFile, value);
}
function from_candid_GameSave_n11(_uploadFile, _downloadFile, value) {
  return from_candid_record_n12(_uploadFile, _downloadFile, value);
}
function from_candid_LeaderboardEntry_n6(_uploadFile, _downloadFile, value) {
  return from_candid_record_n7(_uploadFile, _downloadFile, value);
}
function from_candid_PurchaseRecord_n14(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n16(_uploadFile, _downloadFile, value) {
  return "skin" in value ? "skin" : "powerup" in value ? "powerup" : "weapon" in value ? "weapon" : value;
}
function from_candid_variant_n9(_uploadFile, _downloadFile, value) {
  return "endless" in value ? "endless" : "hardcore" in value ? "hardcore" : "story" in value ? "story" : "bossBattle" in value ? "bossBattle" : value;
}
function from_candid_vec_n1(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_AchievementStatus_n2(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n13(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_PurchaseRecord_n14(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n5(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_LeaderboardEntry_n6(_uploadFile, _downloadFile, x2));
}
function to_candid_GameMode_n23(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n24(_uploadFile, _downloadFile, value);
}
function to_candid_PurchaseRecord_n18(_uploadFile, _downloadFile, value) {
  return to_candid_record_n19(_uploadFile, _downloadFile, value);
}
function to_candid_SubmitScoreRequest_n21(_uploadFile, _downloadFile, value) {
...
function to_candid_vec_n17(_uploadFile, _downloadFile, value) {
  return value.map((x2) => to_candid_PurchaseRecord_n18(_uploadFile, _downloadFile, x2));
}
